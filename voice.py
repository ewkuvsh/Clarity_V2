#!/usr/bin/env python3
"""
uses faster-whisper for real time transcription. Starts recording in 1 second chunks, collating them until speech stops for 2 seconds, then processes. 
"""
import pyaudio
import numpy as np
import time
...
class vad:
    ...
    def is_speech(self, audio_data, update_background=True):
...
class TimerBasedvadProcessor:
    def __init__(self, model_size="base"):
        ...
        self.vad = vad(self.non_speech_threshold)
    ...
    def process_one_second_chunk(self, chunk_data):
        ...
        has_speech = self.vad.is_speech(chunk_data, update_background=not self.recording)
